...
public static class CodeFixContextExtensions
{
    ...
    /// </summary>
    public static async Task<OptionalSyntax<ClassDeclarationSyntax>> FindClass(this CodeFixContext context) =>
    ...
    /// </summary>
    public static async Task<OptionalSyntax<StructDeclarationSyntax>> FindStruct(this CodeFixContext context) =>
    ...
    /// </summary>
    public static async Task<OptionalSyntax<InterfaceDeclarationSyntax>> FindInterface(this CodeFixContext context) =>
    ...
    /// </summary>
    public static async Task<OptionalSyntax<RecordDeclarationSyntax>> FindRecord(this CodeFixContext context) =>
    ...
    /// </summary>
    public static async Task<OptionalSyntax<EnumDeclarationSyntax>> FindEnum(this CodeFixContext context) =>
    ...
    /// </summary>
    public static async Task<OptionalSyntax<MethodDeclarationSyntax>> FindMethod(this CodeFixContext context) =>
    ...
    /// </summary>
    public static async Task<OptionalSyntax<PropertyDeclarationSyntax>> FindProperty(this CodeFixContext context) =>
    ...
    /// </summary>
    public static async Task<OptionalSyntax<FieldDeclarationSyntax>> FindField(this CodeFixContext context) =>
    ...
    /// </summary>
    public static async Task<OptionalSyntax<ConstructorDeclarationSyntax>> FindConstructor(this CodeFixContext context) =>
    ...
    /// </summary>
    public static async Task<OptionalSyntax<EventDeclarationSyntax>> FindEvent(this CodeFixContext context) =>
    ...
    /// </summary>
    public static async Task<OptionalSyntax<ParameterSyntax>> FindParameter(this CodeFixContext context) =>
