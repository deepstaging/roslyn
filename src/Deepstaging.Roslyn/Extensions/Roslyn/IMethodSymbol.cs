...
public static class MethodSymbolQueryExtensions
{
    extension(IMethodSymbol methodSymbol)
    {
        ...
        /// </summary>
        public ParameterQuery QueryParameters() => ParameterQuery.From(methodSymbol);
        ...
        /// </summary>
        public bool IsAsync() => methodSymbol.GetAsyncKind() != AsyncMethodKind.NotAsync;

        /// <summary>
        /// Checks if a method is async void (returns Task with no type arguments).
        /// </summary>
        public bool IsAsyncVoid() => methodSymbol.GetAsyncKind() == AsyncMethodKind.Void;

        /// <summary>
        /// Checks if a method is async value (returns Task&lt;T&gt; or ValueTask&lt;T&gt;).
        /// </summary>
        public bool IsAsyncValue() => methodSymbol.GetAsyncKind() == AsyncMethodKind.Value;
        ...
        /// </summary>
        public bool IsOperator() => methodSymbol.MethodKind == MethodKind.UserDefinedOperator ||
                                    methodSymbol.MethodKind == MethodKind.Conversion;

        /// <summary>
        /// Checks if the method is a constructor.
        /// </summary>
        public bool IsConstructor() => methodSymbol.MethodKind == MethodKind.Constructor;

        /// <summary>
        /// Checks if the method is a destructor/finalizer.
        /// </summary>
        public bool IsDestructor() => methodSymbol.MethodKind == MethodKind.Destructor;

        /// <summary>
        /// Checks if the method is a property accessor (getter or setter).
        /// </summary>
        public bool IsPropertyAccessor() => methodSymbol.MethodKind == MethodKind.PropertyGet ||
                                            methodSymbol.MethodKind == MethodKind.PropertySet;

        /// <summary>
        /// Checks if the method is an event accessor (add or remove).
        /// </summary>
        public bool IsEventAccessor() => methodSymbol.MethodKind == MethodKind.EventAdd ||
        ...
        /// </summary>
        public bool IsPartialMethod() => methodSymbol.PartialDefinitionPart != null ||
                                         methodSymbol.PartialImplementationPart != null;

        /// <summary>
        /// Checks if the method has parameters.
        /// </summary>
        public bool HasParameters() => methodSymbol.Parameters.Length > 0;

        /// <summary>
        /// Checks if the method has ref or out parameters.
        /// </summary>
        public bool HasRefOrOutParameters() => methodSymbol.Parameters.Any(p => p.RefKind is RefKind.Ref or RefKind.Out);
    }
}