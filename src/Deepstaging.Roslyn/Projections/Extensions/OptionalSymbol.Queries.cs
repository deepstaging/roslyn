...
public static class OptionalSymbolQueryExtensions
{
    extension<TSymbol>(OptionalSymbol<TSymbol> symbol) where TSymbol : class, ISymbol
    {
        ...
        /// </summary>
        public MethodQuery QueryMethods() => symbol.OrNull() is ITypeSymbol typeSymbol
        ...
        /// Returns empty results if symbol is not a type or is empty.
        /// </summary>
        public PropertyQuery QueryProperties() => symbol.OrNull() is ITypeSymbol typeSymbol
        ...
        /// Returns empty results if symbol is not a type or is empty.
        /// </summary>
        public ConstructorQuery QueryConstructors() => symbol.OrNull() is ITypeSymbol typeSymbol
        ...
        /// Returns empty results if symbol is not a type or is empty.
        /// </summary>
        public FieldQuery QueryFields() => symbol.OrNull() is ITypeSymbol typeSymbol
        ...
        /// Returns empty results if symbol is not a type or is empty.
        /// </summary>
        public EventQuery QueryEvents() => symbol.OrNull() is ITypeSymbol typeSymbol
        ...
        /// </summary>
        public ParameterQuery QueryParameters() => symbol.OrNull() is IMethodSymbol methodSymbol
