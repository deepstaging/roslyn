...
public static class OptionalSymbolCastingExtensions
{
        ...
        where TSymbol : class, ISymbol
    {
        ...
        public OptionalSymbol<IMethodSymbol> AsMethod() =>
            optional.HasValue && optional.OrThrow() is IMethodSymbol method
        ...
        public OptionalSymbol<IPropertySymbol> AsProperty() =>
            optional.HasValue && optional.OrThrow() is IPropertySymbol property
        ...
        /// </summary>
        public OptionalSymbol<IFieldSymbol> AsField() => optional.HasValue && optional.OrThrow() is IFieldSymbol field
        ...
        public OptionalSymbol<IParameterSymbol> AsParameter() =>
            optional.HasValue && optional.OrThrow() is IParameterSymbol parameter
        ...
        public OptionalSymbol<INamedTypeSymbol> AsNamedType() =>
            optional.HasValue && optional.OrThrow() is INamedTypeSymbol namedType
        ...
        /// </summary>
        public OptionalSymbol<ITypeSymbol> AsType() => optional.HasValue && optional.OrThrow() is ITypeSymbol type
        ...
        public OptionalSymbol<IEventSymbol> AsEvent() =>
            optional.HasValue && optional.OrThrow() is IEventSymbol eventSymbol
        ...
        public OptionalSymbol<INamespaceSymbol> AsNamespace() =>
            optional.HasValue && optional.OrThrow() is INamespaceSymbol ns
        ...
        public OptionalSymbol<ITypeParameterSymbol> AsTypeParameter() =>
            optional.HasValue && optional.OrThrow() is ITypeParameterSymbol typeParam
        ...
        /// </summary>
        public OptionalSymbol<ILocalSymbol> AsLocal() => optional.HasValue && optional.OrThrow() is ILocalSymbol local
