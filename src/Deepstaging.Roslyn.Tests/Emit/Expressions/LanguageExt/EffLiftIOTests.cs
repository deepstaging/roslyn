...
public class EffLiftIOTests
{
    ...
    public async Task AsyncOptional_produces_LiftIO_with_Optional_wrapper()
    {
        ...
        await Assert.That(result)
            .IsEqualTo("global::LanguageExt.Eff<RT, global::LanguageExt.Option<User>>.LiftIO(async rt => Optional(await query(rt).FirstOrDefaultAsync(token)))");
    }
    ...
    public async Task AsyncVoid_produces_LiftIO_with_unit_return()
    {
        ...
        await Assert.That(result)
            .IsEqualTo("global::LanguageExt.Eff<RT, global::LanguageExt.Unit>.LiftIO(async rt => { await rt.Service.DeleteAsync(token); return unit; })");
    }
    ...
    public async Task SyncVoid_produces_LiftIO_with_unit_return()
    {
        ...
        await Assert.That(result)
            .IsEqualTo("global::LanguageExt.Eff<RT, global::LanguageExt.Unit>.LiftIO(rt => { rt.Service.Reset(); return unit; })");
    }
    ...
    public async Task SyncOptional_produces_LiftIO_with_Optional_wrapper()
    {
        ...
        await Assert.That(result)
            .IsEqualTo("global::LanguageExt.Eff<RT, global::LanguageExt.Option<string>>.LiftIO(rt => Optional(rt.Config.TryGetValue(key)))");
    }
