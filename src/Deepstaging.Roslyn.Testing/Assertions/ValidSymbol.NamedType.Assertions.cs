...
public static partial class ValidSymbolNamedTypeAssertions
{
    ...
    public static bool IsClassSymbol(this ValidSymbol<INamedTypeSymbol> symbol) => symbol.Value.TypeKind == TypeKind.Class;
    ...
    public static bool IsInterfaceSymbol(this ValidSymbol<INamedTypeSymbol> symbol) =>
        symbol.Value.TypeKind == TypeKind.Interface;
    ...
    public static bool IsStructSymbol(this ValidSymbol<INamedTypeSymbol> symbol) => symbol.Value.TypeKind == TypeKind.Struct;
    ...
    public static bool IsRecordSymbol(this ValidSymbol<INamedTypeSymbol> symbol) => symbol.IsRecord;
    ...
    public static bool IsPartialSymbol(this ValidSymbol<INamedTypeSymbol> symbol) => symbol.IsPartial;
    ...
    public static bool IsEnumSymbol(this ValidSymbol<INamedTypeSymbol> symbol) => symbol.Value.TypeKind == TypeKind.Enum;
    ...
    public static bool IsDelegateSymbol(this ValidSymbol<INamedTypeSymbol> symbol) =>
        symbol.Value.TypeKind == TypeKind.Delegate;
    ...
    public static bool IsGenericSymbol(this ValidSymbol<INamedTypeSymbol> symbol) => symbol.IsGenericType;
