...
public static partial class OptionalSymbolMethodAssertions
{
    ...
    public static bool IsAsyncSymbol(this OptionalSymbol<IMethodSymbol> symbol) => symbol.IsAsync;
    ...
    public static bool ReturnsVoid(this OptionalSymbol<IMethodSymbol> symbol) => symbol.Map(x => x.Value.ReturnsVoid).Value;
    ...
    public static bool HasParameterCount(this OptionalSymbol<IMethodSymbol> symbol, int count) =>
        symbol.Parameters.Length == count;
    ...
    public static bool IsExtensionMethod(this OptionalSymbol<IMethodSymbol> symbol) => symbol.IsExtensionMethod;
    ...
    public static bool IsGenericMethod(this OptionalSymbol<IMethodSymbol> symbol) =>
        symbol.Map(x => x.Value.IsGenericMethod).Value;
    ...
    public static bool IsConstructor(this OptionalSymbol<IMethodSymbol> symbol) => symbol.MethodKind == MethodKind.Constructor;
    ...
    public static bool HasReturnType(this OptionalSymbol<IMethodSymbol> symbol) => !symbol.Map(x => x.Value.ReturnsVoid).Value;
}