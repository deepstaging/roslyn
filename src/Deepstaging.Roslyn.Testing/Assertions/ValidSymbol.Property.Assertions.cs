...
public static partial class ValidSymbolPropertyAssertions
{
    ...
    public static bool IsReadOnlySymbol(this ValidSymbol<IPropertySymbol> symbol) => symbol.IsReadOnly;
    ...
    public static bool IsWriteOnly(this ValidSymbol<IPropertySymbol> symbol) => symbol.Value.IsWriteOnly;
    ...
    public static bool HasGetter(this ValidSymbol<IPropertySymbol> symbol) => symbol.GetMethod.HasValue;
    ...
    public static bool HasSetter(this ValidSymbol<IPropertySymbol> symbol) => symbol.SetMethod.HasValue;
    ...
    public static bool IsIndexer(this ValidSymbol<IPropertySymbol> symbol) => symbol.Value.IsIndexer;
    ...
    public static bool HasInitOnlySetter(this ValidSymbol<IPropertySymbol> symbol) =>
        symbol.SetMethod.Where(x => x.IsInitOnly).HasValue;
    ...
    public static bool IsRequired(this ValidSymbol<IPropertySymbol> symbol) => symbol.Value.IsRequired;
}