...
public static partial class ValidSymbolAssertions
{
    ...
    public static bool NameContains<T>(this ValidSymbol<T> symbol, string substring) where T : class, ISymbol =>
        symbol.Name.Contains(substring);
    ...
    public static bool IsInternalSymbol<T>(this ValidSymbol<T> symbol) where T : class, ISymbol =>
        symbol.Accessibility == Accessibility.Internal;
    ...
    public static bool IsProtectedSymbol<T>(this ValidSymbol<T> symbol) where T : class, ISymbol =>
        symbol.Accessibility == Accessibility.Protected;
    ...
    public static bool IsStaticSymbol<T>(this ValidSymbol<T> symbol) where T : class, ISymbol => symbol.IsStatic;
    ...
    public static bool IsAbstractSymbol<T>(this ValidSymbol<T> symbol) where T : class, ISymbol => symbol.IsAbstract;
    ...
    public static bool IsSealedSymbol<T>(this ValidSymbol<T> symbol) where T : class, ISymbol => symbol.IsSealed;
    ...
    public static bool IsVirtualSymbol<T>(this ValidSymbol<T> symbol) where T : class, ISymbol => symbol.IsVirtual;
