...
public static partial class OptionalEmitAssertions
{
    ...
    public static bool IsSuccessful(this OptionalEmit emit) => emit.Success;
    ...
    public static bool HasFailed(this OptionalEmit emit) => !emit.Success;
    ...
    public static bool HasValue(this OptionalEmit emit) => emit.HasValue;
    ...
    public static bool IsEmpty(this OptionalEmit emit) => emit.IsEmpty;
    ...
    public static bool HasDiagnostics(this OptionalEmit emit) => emit.Diagnostics.Length > 0;
    ...
    public static bool HasNoDiagnostics(this OptionalEmit emit) => emit.Diagnostics.Length == 0;
    ...
    public static bool HasErrors(this OptionalEmit emit) => emit.Errors.Any();
    ...
    public static bool HasWarnings(this OptionalEmit emit) => emit.Warnings.Any();
    ...
    public static bool CodeContains(this OptionalEmit emit, string text) => emit.Code?.Contains(text) ?? false;
