...
public static partial class OptionalSymbolPropertyAssertions
{
    ...
    public static bool IsReadOnlySymbol(this OptionalSymbol<IPropertySymbol> symbol) => symbol.IsReadOnly;
    ...
    public static bool IsWriteOnly(this OptionalSymbol<IPropertySymbol> symbol) => symbol.Map(x => x.Value.IsWriteOnly).Value;
    ...
    public static bool HasGetter(this OptionalSymbol<IPropertySymbol> symbol) => symbol.GetMethod.HasValue;
    ...
    public static bool HasSetter(this OptionalSymbol<IPropertySymbol> symbol) => symbol.SetMethod.HasValue;
    ...
    public static bool IsIndexer(this OptionalSymbol<IPropertySymbol> symbol) => symbol.Map(x => x.Value.IsIndexer).Value;
    ...
    public static bool HasInitOnlySetter(this OptionalSymbol<IPropertySymbol> symbol) =>
        symbol.SetMethod.Map(x => x.Value.IsInitOnly).HasValue;
    ...
    public static bool IsRequired(this OptionalSymbol<IPropertySymbol> symbol) => symbol.Map(x => x.Value.IsRequired).Value;
}