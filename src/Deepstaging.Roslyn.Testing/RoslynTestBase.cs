...
public abstract class RoslynTestBase
{
    ...
    protected SymbolTestContext SymbolsFor(string source) => new(CompilationHelper.CreateCompilation(source));
    ...
    protected Compilation CompilationFor(string source) => SymbolsFor(source).Compilation;
