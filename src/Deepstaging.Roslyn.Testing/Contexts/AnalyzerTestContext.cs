...
public class AnalyzerTestContext
{
    ...
    {
        var assertion = new DiagnosticAssertion(this, diagnosticId, true);
...
public class DiagnosticsAssertion
{
    ...
    internal async Task VerifyAsync()
    {
        ...
        {
            if (diagnostics.Length == 0) Assert.Fail("Expected diagnostics to be reported, but none were found.");
            return;
        }
