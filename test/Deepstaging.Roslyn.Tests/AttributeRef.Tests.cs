...
public class AttributeRefTests
{
    ...
    [Test]
    public async Task Global_AttributeRef_is_AttributeRef()
    {
        // ReSharper disable once SuggestVarOrType_SimpleTypes
        AttributeRef attr = AttributeRef.From("global::System.ComponentModel.DataAnnotations.KeyAttribute");

        await Assert.That(attr.Value).IsEqualTo("global::System.ComponentModel.DataAnnotations.KeyAttribute");
    }

    [Test]
    public async Task Global_AttributeRef_bridges_to_builder()
    {
        // ReSharper disable once SuggestVarOrType_SimpleTypes
        AttributeBuilder builder = AttributeRef.From("global::System.ComponentModel.DataAnnotations.Schema.ColumnAttribute")
            .WithArgument("\"name\"");
    ...
    [Test]
    public async Task Global_AttributeRef_from_string()
    {
        // ReSharper disable once SuggestVarOrType_SimpleTypes
        AttributeRef attr = AttributeRef.From("global::System.Text.Json.Serialization.JsonConverter");
