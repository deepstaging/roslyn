...
public class ExpressionRefTests
{
    ...
    {
        ExpressionRef expr = (TypeRef)new ListTypeRef("int");
    ...
    {
        var expr = ((TypeRef)new ListTypeRef("string")).New();
    ...
    {
        var expr = TypeRef.Global("System.ArgumentNullException").New("nameof(value)");
    ...
    {
        var expr = TypeRef.Global("System.Threading.Tasks.Task").Call("CompletedTask");
    ...
    {
        var expr = TypeRef.Global("System.ArgumentNullException").Call("ThrowIfNull", "param");
    ...
    {
        var expr = TypeRef.Global("System.Text.Json.Serialization.JsonConverter<OrderId>").TypeOf();
    ...
    {
        var expr = TypeRef.Global("System.Threading.CancellationToken").Default();
    ...
    {
        var expr = TypeRef.Global("System.ArgumentNullException")
    ...
    {
        var expr = TypeRef.Global("System.ArgumentNullException").Call("ThrowIfNull", "value");
    ...
    {
        var expr = TypeRef.Global("System.Text.Json.Serialization.JsonConverter<CustomerId>").TypeOf();
